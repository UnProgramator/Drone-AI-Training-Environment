...
public:
	...
	inline void set_ObjectFactory(DefaultObjectFactory* objf) { this->objf = objf; }
	inline DefaultObjectFactory* get_ObjectFactory() { return this->objf; }

	inline void set_JSONParser(Base_JSONParser* json_p) { this->json_p = json_p; }
	inline Base_JSONParser* get_JSONParser() { return this->json_p; }

	inline void set_PhysicsManager(PhysicsManager* dronePhyMgr) { this->dronePhyMgr = dronePhyMgr; }
