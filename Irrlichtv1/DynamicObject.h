...
public:
	...
	DynamicObject(const std::string& meshPath, const std::string& texturePath, const irr::core::vector3df & position, const irr::core::vector3df& rotation = irr::core::vector3df(0.f, 0.f, 0.f), const irr::core::vector3df& forwardVector = irr::core::vector3df(1.f, 0.f, 0.f), const irr::core::vector3df& scale = irr::core::vector3df(1.f, 1.f, 1.f), bool bHasCollision = true, bool bAddToRaycastDetection = true, const std::string& name = "");
	...
	virtual void setRotation(const irr::core::vector3df & newRotation) override;
